...
namespace HizliSatis.ViewModel
{
   public class StokModelView
    {
        public int sto_RECno { get; set; }

        [Display(Name = "Parekende Satış Fiyatı")]
        public double? P_Satis_Fiyat { get; set; }

        [Display(Name = "Toptan Satış Fiyatı")]
        public double? T_Satis_Fiyat { get; set; }

        [Display(Name = "Kurum Satış Fiyatı")]
        public double? K_Satis_Fiyat { get; set; }
        [Display(Name = "Barkod Numarası")]
        public string BarkodNo { get; set; }
        [Display(Name = "Alış Fiyatı")]
        public double? Alış_Fiyatı { get; set; }
        [Display(Name = "Bakiye")]
        public double? Bakiye { get; set; }
        public List<string> Kod { get; set; }
