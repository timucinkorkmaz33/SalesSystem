namespace HizliSatis.Model
{
    ...
    public partial class UFRS_FISLERI
    {
        [Key]
        ...
        public byte? fis_ticari_evrakcins { get; set; }
        ...
        public int? fis_soz_taksitno { get; set; }
        ...
        public byte? fis_ufrs_kayittipi { get; set; }

        public double? fis_vuk_meblag0 { get; set; }

        public double? fis_vuk_meblag1 { get; set; }

        public double? fis_vuk_meblag2 { get; set; }

        public double? fis_vuk_meblag3 { get; set; }

        public double? fis_vuk_meblag4 { get; set; }

        public double? fis_vuk_meblag5 { get; set; }

        public double? fis_vuk_meblag6 { get; set; }
    }
}
